...
<div title='浏览器市场份额比例图'' 
	...
	data-type='chart' 
	data-js='<s:url value="/ui-libs/highcharts/2.1.8/highcharts.min.js?ts=0" />,<s:url value="/ui-libs/highcharts/2.1.8/modules/exporting.min.js?ts=0" />,<s:url value="/bc-test/chart/pie.js" />'
